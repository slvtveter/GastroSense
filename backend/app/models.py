...
class MenuAnalysis(Base):
    ...
    avg_margin = Column(Decimal(10, 2), nullable=False)
...
class DemandForecast(Base):
    ...
    lower_bound_revenue = Column(Decimal(12, 2), nullable=False)
    upper_bound_revenue = Column(Decimal(12, 2), nullable=False)
    updated_at = Column(DateTime, default=func.now(), onupdate=func.now())
